...
_FLAG = {
    ...
    "whispers_revenue_incomplete": "②決算専門サイトのレコードに売上の実績か"
                                   "予想のどちらかが欠けています(待っても"
                                   "増えません)",
    # 決算専門サイトが出した「アナリストの予想値」を、こちらが安全のため
    # 採らなかったときの理由（T-021）。数値そのものは読めているのに使わない
    # という判断なので、読み手には「取れなかった」と見分けが付かない。何を
    # 見て見送ったのかを書かないと、会社が見通しを出していないのか、こちらが
    # 捨てたのかが区別できない。
    "full_year_period_disputed": "④決算専門サイトの応答の中で、通期の予想が"
                                 "どの年度のものかについて、文章と年度欄が"
                                 "食い違っていました。年度を取り違えると、"
                                 "会社が言っていない上振れ・下振れを作って"
                                 "しまうため、通期の予想は使いませんでした",
    "full_year_amount_unreadable": "④決算専門サイトが通期の予想に触れて"
                                   "いましたが、金額を読み取れる形で"
                                   "書かれていませんでした",
    "next_quarter_period_disputed": "④決算専門サイトの応答の中で、翌四半期の"
                                    "予想がどの四半期のものかについて、文章と"
                                    "四半期欄が食い違っていました。翌四半期の"
                                    "予想は使いませんでした",
    "next_quarter_amount_unreadable": "④決算専門サイトが翌四半期の予想に"
                                      "触れていましたが、金額を読み取れる形で"
                                      "書かれていませんでした",
